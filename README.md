...
This is a work in progress. There are no threads here, only asynchronous I/O calls. I'm taking my time adding IRC-like display functions with the Python curses library slowly and deliberately with all due sloth, so slowly that I would be fired and blacklisted if I were doing this professionally; flunked and expelled if I were a student; wiped out and in debt as if I spent my entire life savings on deeply in-the-money uncovered calls purchased at zero-days to expiration one minute before the market closes while shorting the underlying security at the strike price, and having all the calls immediately exercised in addition to a margin call for the shares I borrowed; and defunded and defrocked if I were an academician. It is, however, a labor of love. 
